...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /***************************************************
    * Utility
    ***************************************************/
  // Fix 1: ปรับปรุง formatDateTH ให้รองรับรูปแบบ DD/MM/YYYY ที่แปลงมาจาก GAS
    ...
    document.querySelectorAll(".move-log").forEach(btn => {
      btn.onclick = async function () {
        ...
        try {
          ...
          // ใช้ค่า วันที่/เวลา ที่แสดงอยู่ในตารางแล้ว
  ...
  function renderManualPage() {
    pageContent.innerHTML = `
      ...
      <ul>
        ...
        <li><strong>รีเฟรช (🔄):** โหลดข้อมูลล่าสุดจากเซิร์ฟเวอร์</li>
      </ul>
